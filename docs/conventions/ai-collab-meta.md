...
| 2026-04-29 | M/L PR 생성 시 이슈와 동일한 라벨/마일스톤을 PR에도 부착하지 않아 PR 목록에서 메타 누락 (#12 #13 #20 #21 #22) | [`response-patterns.md` §4 — PR 메타 동기화](response-patterns.md#4-pr-메타-동기화-라벨마일스톤) + PR 템플릿 체크라인 |
