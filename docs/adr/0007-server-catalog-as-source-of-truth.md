...
## Status
Accepted — 2026-04-28 (Amended same day: 12 → 17 카테고리 확장, 시장조사 반영, [#17](https://github.com/kswift1/PillPouch/issues/17) 진행 중)
...
### 카테고리 17종 (V1.0 시드, 2026-04-28 시장조사 후 12 → 17 확장)

본 ADR 머지 직후 #17 진행 중 한국 시장 조사 결과로 12 → 17종 확장. 추가/변경:
- **calciumMagnesium 분리** → `calcium` + `magnesium` (한국 시장 단독 제품 매우 흔함)
- **redGinseng 신규** (시장 30% 점유, 빠지면 안 됨)
...
| `redGinseng` | 홍삼 | 5 |
| `vitaminD` | 비타민 D | 6 |
| `vitaminB` | 비타민 B (B 컴플렉스 통합) | 7 |
| `milkThistle` | 밀크씨슬 | 8 |
| `glucosamine` | 글루코사민 | 9 |
| `lutein` | 루테인 | 10 |
| `collagen` | 콜라겐 | 11 |
| `magnesium` | 마그네슘 (단독) | 12 |
| `calcium` | 칼슘 (단독) | 13 |
| `iron` | 철분 | 14 |
| `zinc` | 아연 | 15 |
| `coq10` | 코엔자임 Q10 | 16 |
